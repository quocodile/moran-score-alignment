...
if __name__=="__main__":
  ...
  if len(sys.argv) == 1:
    ...
    print("python3 MoranScore.py <gene_name> <reconstructed_slice> <stereo_slice> <reconstruction_mode>")
    print("ex. python3 MoranScore.py gsc 31 2 CTFacTomo") 
    print("-----")
    quit()

  gene = sys.argv[1]
  reconstructed_slice_number = int(sys.argv[2])
  stereo_slice_number = int(sys.argv[3])
  reconstruction_type = sys.argv[4]
